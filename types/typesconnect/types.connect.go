...
var (
	twitterServiceServiceDescriptor         = types.File_types_types_proto.Services().ByName("TwitterService")
...
type TwitterServiceClient interface {
	GetUser(context.Context, *connect.Request[types.UserRequest]) (*connect.Response[types.UserResponse], error)
	GetTweets(context.Context, *connect.Request[types.TweetsRequest]) (*connect.Response[types.TweetsResponse], error)
}
...
func NewTwitterServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TwitterServiceClient {
	...
	return &twitterServiceClient{
		getUser: connect.NewClient[types.UserRequest, types.UserResponse](
			httpClient,
			baseURL+TwitterServiceGetUserProcedure,
			connect.WithSchema(twitterServiceGetUserMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		getTweets: connect.NewClient[types.TweetsRequest, types.TweetsResponse](
			httpClient,
...
type twitterServiceClient struct {
	getUser   *connect.Client[types.UserRequest, types.UserResponse]
	getTweets *connect.Client[types.TweetsRequest, types.TweetsResponse]
}

// GetUser calls TwitterService.GetUser.
func (c *twitterServiceClient) GetUser(ctx context.Context, req *connect.Request[types.UserRequest]) (*connect.Response[types.UserResponse], error) {
	return c.getUser.CallUnary(ctx, req)
}

// GetTweets calls TwitterService.GetTweets.
func (c *twitterServiceClient) GetTweets(ctx context.Context, req *connect.Request[types.TweetsRequest]) (*connect.Response[types.TweetsResponse], error) {
...
func (UnimplementedTwitterServiceHandler) GetUser(context.Context, *connect.Request[types.UserRequest]) (*connect.Response[types.UserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("TwitterService.GetUser is not implemented"))
}

func (UnimplementedTwitterServiceHandler) GetTweets(context.Context, *connect.Request[types.TweetsRequest]) (*connect.Response[types.TweetsResponse], error) {
